...
/**
 * 临时缓冲区和索引缓冲区
 * 创建两个顶点缓冲区，一个缓冲区提供给CPU-HOST内存访问使用，用于从顶点数组中提交数据，另一个顶点缓冲区用于设备local内存，
 * 将会使用缓冲区拷贝的命令将数据从临时缓冲区拷贝到实际图形卡内存中。
 */
...
private:
    ...
    */
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("../../VulkanT15/shaders/vert.spv");
        auto fragShaderCode = readFile("../../VulkanT15/shaders/frag.spv");
        //着色器模型
