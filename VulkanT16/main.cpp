...
/**
 * 索引缓冲区
 * 是一个指向顶点缓冲区的指针数组，它允许我们重排列顶点数据，并复用多个已存在的顶点数据。索引缓冲区，解决顶点重复的问题
 */
...
//            vkCmdDraw(commandBuffers[i], vertices.size(), 1, 0, 0);
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("../../VulkanT16/shaders/vert.spv");
        auto fragShaderCode = readFile("../../VulkanT16/shaders/frag.spv");
        //着色器模型
