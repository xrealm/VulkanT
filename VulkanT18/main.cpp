...
struct Vertex {
    ...
    static std::array<VkVertexInputAttributeDescription, 3> getAttributeDescriptions() {
        ...
        //format-字节单位大小，顶点数据vec2 两个32位即可
...
private:
    ...
    void createTextureImage() {
        ...
        stbi_uc *pixels = stbi_load("../../textures/test_texture.jpg", &texWidth, &texHeight, &texChannels,
                                    STBI_rgb_alpha);
...
//            vkCmdDraw(commandBuffers[i], vertices.size(), 1, 0, 0);
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("../../VulkanT18/shaders/vert.spv");
        auto fragShaderCode = readFile("../../VulkanT18/shaders/frag.spv");
        //着色器模型
